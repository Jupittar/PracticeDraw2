...
public class Practice14MaskFilterView extends View {
  ...
  Bitmap bitmap;
  MaskFilter normalBlur = new BlurMaskFilter(80, BlurMaskFilter.Blur.NORMAL);
  MaskFilter innerBlur = new BlurMaskFilter(80, BlurMaskFilter.Blur.INNER);
  MaskFilter outerBlur = new BlurMaskFilter(80, BlurMaskFilter.Blur.OUTER);
  MaskFilter solidBlur = new BlurMaskFilter(80, BlurMaskFilter.Blur.SOLID);
  ...
  protected void onDraw(Canvas canvas) {
    ...
    // 第一个：NORMAL
    paint.setMaskFilter(normalBlur);
    canvas.drawBitmap(bitmap, 100, 50, paint);

    // 第二个：INNER
    paint.setMaskFilter(innerBlur);
